...
namespace TestProject
{
    ...
    public class UnitTest
    {
        ...
        public void TestMethodWebAPI()
        {
            ...
            System.IO.FileStream objFileStream = new System.IO.FileStream(Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\playlist.m3u8", System.IO.FileMode.Create, System.IO.FileAccess.Write);
